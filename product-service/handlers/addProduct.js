"use strict";
import { DEFAULT_HEADERS, PRODUCT_ADDED_MESSAGE, INVALID_INPUT_MESSAGE, DB_CONNECTION_ERROR_MESSAGE } from "../utils/constants";
...
const getIsPayloadValid = ({ title, description, count, price }) => {
  if (
    !typeof title === 'string' ||
...
export const addProduct = async (event) => {
  console.log('event object for addProduct ', event);
